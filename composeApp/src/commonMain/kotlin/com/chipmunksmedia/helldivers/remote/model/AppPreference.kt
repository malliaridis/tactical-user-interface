    ...
    fun getCollectionById(collectionKey: String) = when (collectionKey) {
        PreferenceCollectionKeys.PCK_SETTINGS -> listOf(
            ...
            AppPreference.LinkPreference(
                ...
                value = "https://github.com/malliaridis/helldivers-remote",
                defaultValue = "https://github.com/malliaridis/helldivers-remote",
            ),
            AppPreference.LinkPreference(
            ...
            AppPreference.DeepLinkPreference(
                ...
                value = "helldivers://remote/licenses",
                defaultValue = "helldivers://remote/licenses",
            ),
        )
